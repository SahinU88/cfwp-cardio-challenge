<div x-show="tableView == 1" class="mt-6">
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            <h2 class="text-xl font-semibold text-gray-900">Team entries all-time</h2>
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                        ...
                        <tfoot class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">{{ number_format(Auth::user()->team->getTotalAllTimeFor('Walking')/ 1000, 2, ',', '.') }}</th>
                                <th class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">{{ number_format(Auth::user()->team->getTotalAllTimeFor('Biking')/ 1000, 2, ',', '.') }}</th></th>
                                <th class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">{{ number_format(Auth::user()->team->getTotalAllTimeFor('Swimming')/ 1000, 2, ',', '.') }}</th></th>
                                <th class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">{{ number_format(Auth::user()->team->getTotalAllTimeFor('SkiErg')/ 1000, 2, ',', '.') }}</th></th>
                                <th class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">{{ number_format(Auth::user()->team->getTotalAllTimeFor('Rowing')/ 1000, 2, ',', '.') }}</th></th>
                                <th class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">{{ number_format(Auth::user()->team->getTotalAllTimeFor('HandstandWalk')/ 1000, 2, ',', '.') }}</th></th>
                                <th class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">{{ number_format(Auth::user()->team->getTotalAllTimeFor('DoubleUnders')/ 1000, 2, ',', '.') }}</th></th>
                                <th class="px-3 py-3.5 text-right text-sm font-semibold text-gray-900">{{ number_format(Auth::user()->team->getTotalAllTimeFor('Burpees')/ 1000, 2, ',', '.') }}</th></th>
                            </tr>
                        </tfoot>
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            <tr @class(['bg-gray-100' => $loop->even])>
                                ...
                                <td class="whitespace-nowrap px-3 py-4 text-right text-sm text-gray-900">{{ number_format($member->getTotalAllTimeFor('Walking')/ 1000, 2, ',', '.') }}</td>
                                <td class="whitespace-nowrap px-3 py-4 text-right text-sm text-gray-900">{{ number_format($member->getTotalAllTimeFor('Biking')/ 1000, 2, ',', '.') }}</td>
